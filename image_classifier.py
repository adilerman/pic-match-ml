...
class ImageClassifier:
    def __init__(self, labeled_images_path):
        ...
        self.labeled_images = glob.glob(f'{labeled_images_path}*.jpg')
...
if __name__ == "__main__":
    labeled_images_path = "/Users/adilerman/PycharmProjects/pic-match-ml/data/v6_roi/labeled/"
    test_image_path = '/Users/adilerman/PycharmProjects/pic-match-ml/data/v6_roi/labeled/class_b_8_class_b.jpg'
