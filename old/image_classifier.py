...
class ImageClassifier:
    def __init__(self, labeled_images_path):
        ...
        self.labeled_images = glob.glob(f'{labeled_images_path}*.j*')  # get all images
...
if __name__ == "__main__":
    labeled_images_path = "/old/data/v6_roi/test1/labeled_data/"
    test_image_path = '/old/data/v6_roi/test1/labeled_data/test_b.jpeg'
